package edu.huhkoa2.Exercises_09;
...
public class Matrix2D {
    ...
    public Matrix2D(int rows, int cols){
        ...
        //DON'T REDECLARE: double [][] data = new double [rows][cols] bc java will see this as a local variable instead
    }
    ...
    //noticed repeated pattern -> made into function
    public boolean isInBounds(int r, int c){
        return (r < data.length && 
                r >= 0 && 
                c < data[r].length && 
                c >= 0);
                //the way we ordered this it would short circuit not break if row was wrong, that's good
    }
